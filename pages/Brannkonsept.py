...
def create_full_report_pdf(name, client, content, maps):
    ...
    pdf.draw_cover_meta_items([("OPPDRAGSGIVER:", client), ("DATO:", datetime.now().strftime("%d. %m. %Y")), ("UTARBEIDET AV:", "Builtly RIBr AI Engine"), ("REGELVERK:", pd_state.get('land', 'Norge'))])
    ...
    toc = ['1. SAMMENDRAG OG KONKLUSJON', '2. PROSJEKTBESKRIVELSE OG REGELVERK', '3. KLASSIFISERING', '4. RØMNINGSFORHOLD OG LEDESYSTEM', '5. BRANNCELLER OG BRANNMOTSTAND', '6. SLOKKEUTSTYR OG REDNINGSBRANNVESEN', 'VEDLEGG: VURDERT TEGNINGSGRUNNLAG']
    for t in toc:
        pdf.set_x(25)
    ...
    if maps and len(maps) > 0:
        ...
        pdf.set_font('Helvetica', 'B', 16)
        pdf.set_text_color(26, 43, 72)
        pdf.cell(0, 20, 'VEDLEGG: VURDERT TEGNINGSGRUNNLAG', 0, 1)
