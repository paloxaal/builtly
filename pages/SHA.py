...
st.markdown("<p style='color: var(--muted); font-size: 1.1rem; margin-bottom: 2rem;'>AI-agent for generering av prosjektspesifikk SHA-plan ihht. Byggherreforskriften.</p>", unsafe_allow_html=True)
