...
TEXT = {
    "no": {
        ...
        "hero_sub": "Last opp tegninger, velg hva du vil optimalisere, og generer en rapport med scenarioer, for/etter-tabeller, PDF og Excel.",
        "eyebrow": "Arealanalyse",
        "pills": ["Tegningsanalyse", "Salgbart areal", "Utleibart areal", "For/etter", "PDF + Excel"],
        "back": "Tilbake",
        "open_project": "Prosjektoppsett",
        "open_front": "Forside",
        "goal": "Hva vil du oppna?",
        "goals": ["Mer salgbart areal", "Mer utleibart areal", "Mindre tekniske rom", "Mindre kjerne", "Bedre miks og flyt"],
        "mode": "Ambisjonsniva",
        "modes": ["Konservativ", "Balansert", "Ambisios"],
        "use": "Primar bruk",
        "uses": ["Kontor", "Bolig", "Mixed-use", "Hotell"],
        "gross": "Bruttoareal (m2)",
        "net": "Nettoareal (m2)",
        "core": "Kjerne (m2)",
        "tech": "Tekniske rom (m2)",
        "circ": "Kommunikasjon (m2)",
        "common": "Felles / stotte (m2)",
        "floors": "Etasjer",
        "value": "Verdi per m2",
        "friction": "Markedsfriksjon",
        "level": "Leveranseniva",
        "levels": ["Auto", "Gjennomgatt"],
        "constraints": "Prosjektbegrensninger",
        "constraint_labels": [
            "Ikke svekk brann- og romningslogikk",
        ...
        "empty": "Kjor analysen for a se scenarioer, tegningsfunn og nedlastinger.",
        "downloads": "Nedlastinger",
        "dl_pdf": "Last ned rapport (PDF)",
        "dl_xlsx": "Last ned for/etter (Excel)",
        "dl_json": "Last ned analysegrunnlag (JSON)",
        "baseline": "Baseline",
        "scenarios": "Scenarioer",
        "before_after": "For/etter",
        "findings": "Tegningsfunn",
        "report": "Rapportutkast",
        "sources": "Kilder",
        "what_you_get": "Dette far du",
        "what_items": [
            "Baseline for brutto, netto, salgbart, utleibart og serviceareal",
            "Tre scenarioer med for/etter og estimert verdipotensial",
            "Tegningsbaserte funn og konkrete forbedringsgrep",
            "PDF-rapport og Excel med for/etter-tabeller",
        ],
        "how_use": "Slik bruker du modulen",
        "how_items": [
            "Legg inn dagens arealtall",
            "Velg mal og ambisjonsniva",
            "Last opp tegningsgrunnlag",
            "Generer analyse, rapport og for/etter-uttrekk",
        ],
        "ai_note": "Alle scenarioer ma vurderes mot brann, akustikk, struktur, teknikk, dagslys og marked for de brukes eksternt.",
        "best": "Beste scenario",
        ...
        "find_sub": "Analysen bruker tegningsgrunnlag og arealdata sammen for a foresla realistiske forbedringsgrep.",
        "need_input": "Legg inn arealtall og gjerne last opp minst en plantegning for et bedre resultat.",
        ...
        "disclaimer_auto": "Dette er et AI-generert beslutningsgrunnlag. Det er ikke en faglig attestasjon og ma kvalitetssikres for bruk i investering, prosjektering eller avtale.",
        "disclaimer_review": "Dette utkastet er laget for gjennomgang. Det er ikke en attestert fagrapport og ma kvalitetssikres for bruk i investering, prosjektering eller avtale.",
...
with left:
    ...
    render_metric_cards([
        {"label": tx("yield_now"), "value": f"{base['yield'] * 100:.1f}%", "desc": "Share of value-creating area in the current layout." if UI_LANG == "en" else "Andel verdiskapende areal i dagens losning."},
