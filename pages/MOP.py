...
def create_full_report_pdf(name, client, content, maps):
    ...
    pdf.draw_cover_meta_items([("OPPDRAGSGIVER:", client), ("DATO:", datetime.now().strftime("%d. %m. %Y")), ("UTARBEIDET AV:", "Builtly Miljørådgiver AI"), ("REGELVERK:", "Norsk Standard / TEK")])
    ...
    toc = ['1. DOKUMENTINFORMASJON', '2. PROSJEKTBESKRIVELSE OG MILJØKONTEKST', '3. MILJØMÅL OG FOKUSOMRÅDER', '4. MILJØASPEKTREGISTER', '5. TILTAKSPLAN (MOP-KJERNE)', '6. OPPFØLGING OG RAPPORTERING', '7. ÅPNE AVKLARINGER', '8. HANDLINGSLISTE FOR NESTE FASE']
    for t in toc:
        pdf.set_x(25)
    ...
    pdf.add_page()
    render_report_body(pdf, content, field_labels=['Mål', 'Tiltak', 'Fase', 'Ansvarlig', 'Ansvar', 'Indikator', 'KPI', 'Kontroll', 'Kontrollmetode', 'Avvikshåndtering', 'Avvik', 'Status', 'Prioritet', 'Dokumentasjon', 'Prosjektbeskrivelse', 'Miljøkontekst'], metadata_sections=['1. DOKUMENTINFORMASJON'])
