...
# Dette låser logoen din fast helt øverst i sidemenyen i perfekt størrelse
...
<style>
    ...
    /* Global Dark Mode - Veldig ren og dyp grå/svart */
    .stApp {
    ...
    /* Fjerner Streamlit-støy */
    header {visibility: hidden;}
    
    /* Gjør sidemenyen sømløs med bakgrunnen */
    [data-testid="stSidebar"] {
        background-color: #09090b !important;
        border-right: 1px solid #27272a !important;
    }
    
    /* Senter-innhold spacing */
    .block-container {
        padding-top: 3rem !important;
        max-width: 1200px !important;
    }
    
    /* Ren og profesjonell Header */
    .main-header {
        margin-bottom: 3rem;
    ...
    /* Minimalistisk Grid for Moduler */
    .card-grid {
        display: grid;
...
# --- 4. HTML LAYOUT (Skrevet flush-venstre for å unngå Streamlit-feil) ---
html_content = """
