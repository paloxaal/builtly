...
TEXTS = {'🇬🇧 English (UK)': {'rule_set': 'United Kingdom (Building Regulations / Approved Documents)',
                     ...
                     'stat2_v': 'Human-in-the-loop',
                     'stat2_t': 'Where it counts',
                     'stat2_d': 'Qualified professionals sign off where the law requires it.',
                     'stat3_v': 'PDF + DOCX',
 ...
 '🇳🇴 Norsk': {'rule_set': 'Norge (TEK17 / plan- og bygningsloven)',
              ...
              'stat2_v': 'Human-in-the-loop',
              'stat2_t': 'Der det teller',
              'stat2_d': 'Fagpersoner med ansvarsrett inn der loven krever det.',
              'stat3_v': 'PDF + DOCX',
