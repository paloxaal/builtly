...
def _split_core_for_multi_clusters(
    ...
    *,
    ...
    central_void = max(12.0, min(24.0, central_void))
    ...
    desired_w = 76.0 if cluster_count >= 4 else 72.0
    desired_h = 72.0 if cluster_count >= 4 else 70.0
    edge_margin = max(2.0, min(7.0, float(gap_m or 4.0)))
